...
switch (_mode) do {
    case 1: {
        ...
        _query = format ["UPDATE vehicles SET gear='%3' WHERE pid='%1' AND id='%2'",_uid,_plate,_cargo];
    ...
    case 2: {
        ...
        _query = format ["UPDATE vehicles SET inventory='%3' WHERE pid='%1' AND id='%2'",_uid,_plate,_trunk];
        _thread = [_query,1] call DB_fnc_asyncCall;
    };
};