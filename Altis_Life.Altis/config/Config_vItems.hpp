...
class VirtualShops {
    ...
    class market {
        ...
        side = "civ";
        conditions = "";
        items[] = { "waterBottle", "rabbit", "apple", "redgull", "tbacon", "pickaxe", "toolkit", "fuelFull", "peach", "storagesmall", "storagebig", "rabbit_raw", "hen_raw", "rooster_raw", "sheep_raw", "goat_raw", "frogtrap" };
    };
    ...
    class diamond {
        ...
        side = "civ";
        conditions = "";
        items[] = { "diamond_uncut", "diamond_cut" ,"jewellry"};
    };
    ...
    class blackmarket {
        ...
        side = "civ";
        conditions = "";
        items[] = { "black_powder", "uran", "grenade" };
    };
...
class VirtualItems {
    ...
    class grenade {
        ...
        edible = -1;
        drinkable = -1;
        icon = "icons\ico_grenade.paa";
    };

    class coal_ore {
        variable = "coal_ore";
        displayName = "STR_Item_Coal_Ore";
        weight = 6;
        buyPrice = -1;
        sellPrice = -1;
        illegal = true;
    ...
    class black_powder {
        variable = "black_powder";
        displayName = "STR_Item_Black_Powder";
        weight = 3;
        buyPrice = -1;
        sellPrice = 23000;
        illegal = true;
        edible = -1;
        drinkable = -1;
        icon = "icons\ico_black_powder.paa";
    };
    ...
    class snake {
        ...
        edible = -1;
        drinkable = -1;
        icon = "icons\ico_snake.paa";
        processedItem = "snake_venom";
    };

    class snake_venom {
        variable = "snake_venom";
        ...
        edible = -1;
        drinkable = -1;
        icon = "icons\ico_snake_venom.paa";
    };
