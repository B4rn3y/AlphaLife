...
class Clothing {
    class bruce {
        ...
        uniforms[] = {
            ...
            { "U_C_FormalSuit_01_black_F", "", 15000, "" },
            { "U_C_FormalSuit_01_tshirt_gray_F", "", 15000, "" },
            { "U_C_FormalSuit_01_tshirt_black_F", "", 15000, "" },
        ...
        backpacks[] = {
            ...
            { "B_Bergen_dgtl_f", "", 50000, "" }, //Apex DLC
            { "B_Bergen_tna_f", "", 50000, "" } //Apex DLC
        };
    };
