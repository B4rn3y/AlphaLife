...
if(life_gangdata isEqualTo [] && playerside isEqualTo civilian) exitWith {["Du musst in einer Gang sein um die Gang-Area einnehmen zu können"] spawn life_fnc_exp_hint;};
...
for "_i" from 0 to 1 step 0 do {
    ...
    if(life_gangdata isEqualTo [] && playerside isEqualTo civilian) exitWith {};
    if(isnil "life_gangdata" && playerside isEqualTo civilian) exitWith {};
...
if(life_gangdata isEqualTo [] && playerside isEqualTo civilian) exitWith {["Du musst in einer Gang sein um die Gang-Area einnehmen zu können"] spawn life_fnc_exp_hint;call _abort_capturing;};
