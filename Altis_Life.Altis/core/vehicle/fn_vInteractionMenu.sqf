...
switch (playerside) do
{
    case west:
    {
        ...
        if (_curTarget isKindOf "Ship") then {
            ...
            _Btn6 buttonSetAction "life_vInact_curTarget setPosatl [getPosatl life_vInact_curTarget select 0, getPosatl life_vInact_curTarget select 1, (getPosatl life_vInact_curTarget select 2)+2];[life_vInact_curTarget,[0,0,1]] remoteExec [""setvectorup"", 0]; closeDialog 0;";
    ...
    case independent:
    {
        if (_curTarget isKindOf "Ship") then {
            ...
            _Btn2 buttonSetAction "life_vInact_curTarget setPosatl [getPosatl life_vInact_curTarget select 0, getPosatl life_vInact_curTarget select 1, (getPosatl life_vInact_curTarget select 2)+2]; [life_vInact_curTarget,[0,0,1]] remoteExec [""setvectorup"", 0];closeDialog 0;";
