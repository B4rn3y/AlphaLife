...
with uiNamespace do {
	...
	_cur ctrlCommit 0;
	_cur buttonSetAction "1 spawn life_fnc_sz_find";
	...
	_cur call _sideColor; //ctrlSetBackgroundColor [-1,-1,-1,1];
	_cur ctrlCommit 0;
	_cur buttonSetAction "2 spawn life_fnc_sz_find";
	_cur ctrlSetTooltip "Vorhandene Sperrzone grau markieren";
	_cur call _pushIntoArray;
	...
	_cur call _sideColor; //ctrlSetBackgroundColor [-1,-1,-1,1];
	_cur ctrlCommit 0;
	_cur buttonSetAction "3 spawn life_fnc_sz_find";
	_cur ctrlSetTooltip "Vorhandene Sperrzone grau markieren";
	_cur call _pushIntoArray;
	...
	_cur call _sideColor; //ctrlSetBackgroundColor [-1,-1,-1,1];
	_cur ctrlCommit 0;
	_cur buttonSetAction "4 spawn life_fnc_sz_find";
	_cur ctrlSetTooltip "Vorhandene Sperrzone grau markieren";
	_cur call _pushIntoArray;
	...
	_cur ctrlCommit 0;
	_cur buttonSetAction "1 spawn life_fnc_sz_add";
	...
	_cur ctrlSetTextColor [-1,1,-1,1];
	_cur ctrlCommit 0;
	_cur buttonSetAction "2 spawn life_fnc_sz_add";
	_cur ctrlSetTooltip "Sperrzone erstellen";
	_cur call _pushIntoArray;
	...
	_cur ctrlSetTextColor [-1,1,-1,1];
	_cur ctrlCommit 0;
	_cur buttonSetAction "3 spawn life_fnc_sz_add";
	_cur ctrlSetTooltip "Sperrzone erstellen";
	_cur call _pushIntoArray;
	...
	_cur ctrlSetTextColor [-1,1,-1,1];
	_cur ctrlCommit 0;
	_cur buttonSetAction "4 spawn life_fnc_sz_add";
	_cur ctrlSetTooltip "Sperrzone erstellen";
	_cur call _pushIntoArray;
	...
	_cur ctrlSetTextColor [1,-1,-1,1];
	_cur ctrlCommit 0;
	_cur buttonSetAction "1 spawn life_fnc_sz_del";
	...
	_cur ctrlSetTextColor [1,-1,-1,1];
	_cur ctrlCommit 0;
	_cur buttonSetAction "2 spawn life_fnc_sz_del";
	_cur ctrlSetTooltip "Sperrzone entfernen";
	_cur call _pushIntoArray;
	...
	_cur ctrlSetTextColor [1,-1,-1,1];
	_cur ctrlCommit 0;
	_cur buttonSetAction "3 spawn life_fnc_sz_del";
	_cur ctrlSetTooltip "Sperrzone entfernen";
	_cur call _pushIntoArray;
	...
	_cur ctrlSetTextColor [1,-1,-1,1];
	_cur ctrlCommit 0;
	_cur buttonSetAction "4 spawn life_fnc_sz_del";
	_cur ctrlSetTooltip "Sperrzone entfernen";
	_cur call _pushIntoArray;
	...
	player createDiaryRecord ["sperrzonensystem", ["UI ein-/ausblenden", "<br/><execute expression='call life_fnc_sz_hideGUI'>Klicke hier, um das Overlay zur Sperrzonenverwaltung ein- oder auszublenden.</execute>" ]];
};
